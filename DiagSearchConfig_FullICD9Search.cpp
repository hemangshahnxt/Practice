...
CDiagSearchConfig_FullICD9Search::CDiagSearchConfig_FullICD9Search(bool bIncludePCS)
	: CDiagSearchConfig(eFullICD9_Search, bIncludePCS)
{
}


//ICD9 search specific handling of the search results.  See base class for implementation requirements.
CDiagSearchResults CDiagSearchConfig_FullICD9Search::ConvertRowToSearchResults(NXDATALIST2Lib::IRowSettingsPtr pSearchRow)
{
...
void CDiagSearchConfig_FullICD9Search::CreateResultList(NXDATALIST2Lib::_DNxDataListPtr pDataList, ADODB::_ConnectionPtr pCon)
{
	...
	//create our ICD 9 search specific columns	
	...
	//set the provider
	CDiagSearch_DataListProvider* provider = new CDiagSearch_DataListProvider_FullICD9Search(pCon, m_bIncludePCS);
