...
--&gt;</style>
  ...
  <xsl:template name="footer">
	...
	The stylesheet used to generate this view of the CCR was provided by the American Academy of Family Physicians and the CCR Acceleration Task Force with modifications by NexTech Systems LLC. Licensed under the Apache License, Version 2.0.
</font>
          </th>
        </tr>
        <tr>
