...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function getCanvasDimensions() {
			...
			// (r.gonet 11/12/2012) - PLID 53608 - 0 width and 0 height are now acceptable values. If our EMR Preview pane gets
			// shrunk far enough, then the canvas can have 0 width or height. I apologize in advance for branching the Flot project
			// on this matter.
